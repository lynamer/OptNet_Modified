...
def get_net(args):
    if args.model == 'densenet':
        ...
        net = models.OptNetEq(28*28, args.nHidden, 10, args.neq, args.nineq)
    elif args.model == 'ours':
        net = models.Ours(28 * 28, args.nHidden, 10, args.neq, args.nineq)
    elif args.model == 'CNN':
        net = models.CNN(28 * 28, args.nHidden, 10, args.neq, args.nineq)
    else:
        assert(False)
...
def main():
    ...
    optnetEqP.add_argument('--nHidden', type=int, default=200)
    optnetEqP.add_argument('--neq', type=int, default=50)
    optnetEqP.add_argument('--nineq', type=int, default=50)
    ...
    cnnP = subparsers.add_parser('CNN')
    cnnP.add_argument('--n_kernels', type=int, default=16)
